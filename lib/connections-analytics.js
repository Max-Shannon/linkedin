...
function computeConnectionsAnalytics(connections) {
  ...
  return {
    ...
    summary: {
      total,
      withTitle,
      withTitlePct: total ? Math.round((withTitle / total) * 100) : 0,
      dated,
      datedPct: total ? Math.round((dated / total) * 100) : 0,
      withCompany,
      withCompanyPct: total ? Math.round((withCompany / total) * 100) : 0,
