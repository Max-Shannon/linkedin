...
- ReConnect™ (`npm run reconnect`) — prints the fourteen-day daily meme cadence it would inflict on the people you were about to remove, reports the meme funnel, and sends absolutely none of it ([docs](docs/RECONNECT.md))
